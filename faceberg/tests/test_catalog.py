...
class TestNamespaceOperations:
    ...
    def test_list_namespaces_with_tables(self, catalog, test_schema):
    ...
    def test_drop_namespace_not_empty(self, catalog, test_schema):
    ...
    def test_create_namespace_already_exists(self, catalog, test_schema):
...
class TestTableRead:
    ...
    def test_load_table(self, catalog, test_schema):
    ...
    def test_list_tables(self, catalog, test_schema):
        """Test listing tables."""
        catalog.create_namespace("default")
    ...
    def test_table_exists(self, catalog, test_schema):
...
class TestTableWrite:
    ...
    def test_create_table(self, catalog, test_schema):
        """Test table creation."""
        catalog.create_namespace("default")
    ...
    def test_drop_table(self, catalog, test_schema):
    ...
    def test_rename_table(self, catalog, test_schema):
    ...
    def test_rename_table_destination_exists(self, catalog, test_schema):
